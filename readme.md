...
<div align="center">
<br>
<img style="display: block; width:50%; margin: 20px auto" src="http://cdn2.wcplus.cn/wcplusProLogo.png"/>
<br>
<p>一个用Python实现的微信公众号数据采集、分析软件，服务于5,000多位客户。提供安装包、提供源代码，一键运行</p>
<img src="http://cdn2.wcplus.cn/capture.jpeg"/>
</div>
